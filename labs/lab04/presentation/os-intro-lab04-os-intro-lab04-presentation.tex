...
\begin{frame}
title: \enquote{Структура научной презентации} author: \enquote{Дмитрий
Сергеевич Кулябов} lang: ru-RU format: beamer: theme: \enquote{Madrid}
latex-engine: xelatex \# \textless-- ключевая строка mainfont:
\enquote{Liberation Serif} \# опционально, но желательно sansfont:
\enquote{Liberation Sans} monofont: \enquote{Liberation Mono}---
\end{frame}
